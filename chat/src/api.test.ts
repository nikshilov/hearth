...
describe('normalizeIngestObservations', () => {
  test('converts Heart shorthand observations into Pulse capture observations', () => {
    expect(
      normalizeIngestObservations([
        { text: 'Привет из Heart', ts: '2026-05-02T04:00:00.000Z' },
      ]),
    ).toEqual([
      {
        source_kind: 'heart_chat',
        source_id: 'heart_chat:2026-05-02T04:00:00.000Z',
        scope: 'nik',
        captured_at: '2026-05-02T04:00:00.000Z',
        observed_at: '2026-05-02T04:00:00.000Z',
        version: 1,
        content_text: 'Привет из Heart',
